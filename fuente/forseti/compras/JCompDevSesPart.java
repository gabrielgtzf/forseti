...
public class JCompDevSesPart 
{
	  ...
	  public JCompDevSesPart()
	  {
	  }

	  public JCompDevSesPart(float Cantidad, String Unidad, String ID_Prod, String ID_ProdNombre, float Precio, float Importe, 
