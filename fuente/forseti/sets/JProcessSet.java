...
public class JProcessSet extends JManejadorSet
{
        public JProcessSet(HttpServletRequest request)
        {
                m_PageSize = 50;
	  ...
	  protected void BindRow()
        {
                try
                {
                        ...
                        for(int i = 0; i < getNumCols(); i++)
                        {
                          ...
                          String nombreCol = "Col" + (i+1);
                          pNode.setSTS(nombreCol, m_RS.getString(md.getNombreCol()));
                        }
