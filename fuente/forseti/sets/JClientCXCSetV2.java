...
public class JClientCXCSetV2 extends JManejadorSet
{
	public JClientCXCSetV2(HttpServletRequest request)
	{
		m_Select = " * FROM view_client_cxc_modulo";
		m_PageSize = 50;
		this.request = request;
	}

	public view_client_cxc_modulo getRow(int row)
	{
		return (view_client_cxc_modulo)m_Rows.elementAt((getFloorRow() + row));
	}

	public view_client_cxc_modulo getAbsRow(int row)
	{
		return (view_client_cxc_modulo)m_Rows.elementAt(row);
	}
  ...
  protected void BindRow()
	{
		try
		{
			view_client_cxc_modulo pNode = new view_client_cxc_modulo();
