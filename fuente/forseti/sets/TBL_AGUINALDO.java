...
public class TBL_AGUINALDO
{
	private int m_ID_Aguinaldo;
	private float m_Desde;
	private float m_Hasta;
	private byte m_Dias;

	public void setID_Aguinaldo(int ID_Aguinaldo)
	{
		m_ID_Aguinaldo = ID_Aguinaldo;
	}
	...
	public int getID_Aguinaldo()
	{
		return m_ID_Aguinaldo;
	}
