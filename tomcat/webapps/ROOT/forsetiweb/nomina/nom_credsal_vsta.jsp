		 ...
		 <tr> 
          <td> 
		    <div align="right"> 
              ...
              <input name="submit" type="image" onClick="javascript:establecerProcesoSVE(this.form.proceso, 'CONSULTAR_CREDSAL',<%= JUtil.Msj("CEF","NOM_CREDSAL","VISTA","CONSULTAR_CREDSAL",4) %>,<%= JUtil.Msj("CEF","NOM_CREDSAL","VISTA","CONSULTAR_CREDSAL",5) %>)" src="../imgfsi/<%= JUtil.Msj("CEF","NOM_CREDSAL","VISTA","CONSULTAR_CREDSAL") %>" alt="" title="<%= JUtil.Msj("CEF","NOM_CREDSAL","VISTA","CONSULTAR_CREDSAL",2) %>" border="0">
