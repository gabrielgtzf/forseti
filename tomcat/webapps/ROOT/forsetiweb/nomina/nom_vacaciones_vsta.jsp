		 ...
		 <tr> 
          <td> 
		    <div align="right"> 
              ...
              <input name="submit" type="image" onClick="javascript:establecerProcesoSVE(this.form.proceso, 'CONSULTAR_VACACIONES',<%= JUtil.Msj("CEF","NOM_VACACIONES","VISTA","CONSULTAR_VACACIONES",4) %>,<%= JUtil.Msj("CEF","NOM_VACACIONES","VISTA","CONSULTAR_VACACIONES",5) %>)" src="../imgfsi/<%= JUtil.Msj("CEF","NOM_VACACIONES","VISTA","CONSULTAR_VACACIONES") %>" alt="" title="<%= JUtil.Msj("CEF","NOM_VACACIONES","VISTA","CONSULTAR_VACACIONES",2) %>" border="0">
