		 ...
		 <tr> 
          <td> 
		    <div align="right"> 
              ...
              <input type="image" onClick="javascript: if(confirm('<%= JUtil.Msj("GLB","GLB","GLB","CONFIRMACION",2) %>')) { establecerProcesoSVE(this.form.proceso, 'ELIMINAR_ISR'); } else { return false; } " src="../imgfsi/<%= JUtil.Msj("CEF","NOM_ISR","VISTA","ELIMINAR_ISR") %>" alt="" title="<%= JUtil.Msj("CEF","NOM_ISR","VISTA","ELIMINAR_ISR",2) %>" border="0">
              <a href="/servlet/CEFReportesCtrl?tipo=NOM_ISR" target="_self"><img src="../imgfsi/rep_nomina.png" alt="" title="<%= JUtil.Msj("GLB","GLB","GLB","REPORTES") %>" width="30" height="30" border="0"></a> 
