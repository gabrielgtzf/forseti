...
<%
    ...
    JNominaEntidadesSetIds set = new JNominaEntidadesSetIds(request,usuario,"CEF-X");
    set.Open();
	for(int i = 0; i < set.getNumRows(); i++)
	{
		String str = set.getAbsRow(i).getDescripcion(); 
%>
oCMenu.makeMenu('top<%=i%>','','&nbsp;<%=str%>','/servlet/CEFNomCierreDiarioCtrl?entidad=<%=set.getAbsRow(i).getID_Sucursal()%>','cuerpo')
<%
	} 
%>
