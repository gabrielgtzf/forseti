		 ...
		 <tr> 
          <td> 
		    <div align="right"> 
              ...
              <input type="image" onClick="javascript: if(confirm('<%= JUtil.Msj("GLB","GLB","GLB","CONFIRMACION",2) %>')) { establecerProcesoSVE(this.form.proceso, 'ELIMINAR_IMSS'); } else { return false; } " src="../imgfsi/<%= JUtil.Msj("CEF","NOM_IMSS","VISTA","ELIMINAR_IMSS") %>" alt="" title="<%= JUtil.Msj("CEF","NOM_IMSS","VISTA","ELIMINAR_IMSS",2) %>" border="0">
              <a href="/servlet/CEFReportesCtrl?tipo=NOM_IMSS" target="_self"><img src="../imgfsi/rep_nomina.png" alt="" title="<%= JUtil.Msj("GLB","GLB","GLB","REPORTES") %>" width="30" height="30" border="0"></a> 
