...
<%
	...
	JComercioExteriorCabSet set = new JComercioExteriorCabSet(request,"COMPRA");
            ...
            <td align="right" class="clockCef"> 
              <%  if(JUtil.getSesion(request).getID_Mensaje() == 0 && request.getAttribute("ID_Factura") == null) { %>
        			...
        			<input type="submit" name="aceptar" value="<%= JUtil.Msj("GLB","GLB","GLB","ACEPTAR") %>">
       				<%  } %>
        			<input type="button" name="cancelar" onClick="javascript:document.location.href='/servlet/CEFCompFactCtrl'" value="<%= JUtil.Msj("GLB","GLB","GLB","CANCELAR") %>">
            </td>
          </tr>
        </table> 
      </td>
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="0">
		  <tr bgcolor="#CCCCCC"> 
            <td colspan="6" class="titChico" align="center"><input name="subproceso" type="hidden" value="ENVIAR"> 
              <input name="proceso" type="hidden" value="DATOS_IMPORTACION"> 
              <input name="ID" type="hidden" value="<%= ID %>"> 
              <input name="tipomov" type="hidden" value="<%= request.getParameter("tipomov") %>">Datos Generales de Importacion</td>
          </tr>
          <tr> 
			...
			<select name="tipooperacion">
                ...
                <option value="2"<% if(request.getParameter("tipooperacion") != null) {
										...
										out.println(" selected"); 
									} %>>Importacion de bienes o productos</option>
                <option value="A"<% if(request.getParameter("tipooperacion") != null) {
										...
										out.println(" selected"); 
									} %>>Importacion de servicios</option>
              </select>
			</td>
		  ...
		  <tr> 
		  	<td width="15%">No. de importador</td>
...
%>
		  ...
		  <tr>
			...
			<tr bgcolor="#CCCCCC"> 
             <td colspan="6" class="titChico" align="center">Remitente</td>
            </tr>
			<tr>
			 <td width="15%">CURP</td>
