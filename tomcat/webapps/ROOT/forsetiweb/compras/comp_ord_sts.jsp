...
*************************************/
oCMenu.makeMenu('top0','','&nbsp;<%= JUtil.Elm(sts,1) %>','/servlet/CEFCompOrdenesCtrl?status=TODAS','cuerpo')
oCMenu.makeMenu('top1','','&nbsp;<%= JUtil.Elm(sts,2) %>','/servlet/CEFCompOrdenesCtrl?status=GENERADAS','cuerpo')
oCMenu.makeMenu('top2','','&nbsp;<%= JUtil.Elm(sts,3) %>','/servlet/CEFCompOrdenesCtrl?status=CANCELADAS','cuerpo')
oCMenu.makeMenu('top3','','&nbsp;<%= JUtil.Elm(sts,4) %>','/servlet/CEFCompOrdenesCtrl?status=FACTURADAS','cuerpo')
