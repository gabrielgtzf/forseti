...
<%
    ...
    JComprasEntidadesSetIdsV2 set = new JComprasEntidadesSetIdsV2(request,usuario,"CEF-X",0);
    set.Open();
	for(int i = 0; i < set.getNumRows(); i++)
	{
		String str = set.getAbsRow(i).getDescripcion(); 
%>
oCMenu.makeMenu('top<%=i%>','','&nbsp;<%=str%>','/servlet/CEFCompDevolucionesCtrl?entidad=<%=set.getAbsRow(i).getID_Entidad()%>','cuerpo')
<%
	} 
%>
