...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="400" height="50"><img src="../imgfsi/folder_portal.gif" border="0" usemap="#Map"></td>
...
<map name="Map">
  <area shape="rect" coords="85,29,209,42" href="../../forsetidoc/index.html" target="_blank">
</map>
</body>
</html>
