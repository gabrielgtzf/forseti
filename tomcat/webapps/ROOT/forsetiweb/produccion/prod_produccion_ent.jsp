...
<%
    ...
    JProdEntidadesSetIdsV2 set = new JProdEntidadesSetIdsV2(request,usuario,"CEF-X");
    set.Open();
	for(int i = 0; i < set.getNumRows(); i++)
	{
		String str = set.getAbsRow(i).getDescripcion(); 
%>
oCMenu.makeMenu('top<%=i%>','','&nbsp;<%=str%>','/servlet/CEFProdProduccionCtrl?entidad=<%=set.getAbsRow(i).getID_Entidad()%>','cuerpo')
<%
	} 
%>
