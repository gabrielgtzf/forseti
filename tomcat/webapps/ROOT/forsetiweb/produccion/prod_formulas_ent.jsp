...
.clLevel0{background-color:gray; layer-background-color:#000099; color:white;}
...
%>
oCMenu.makeMenu('top<%=i%>','','&nbsp;<%=str%>','/servlet/forseti.produccion.JProdFormulasCtrl?entidad=<%=set.getAbsRow(i).getClave()%>','cuerpo')
<%
	} 
%>
