...
<%
    ...
    JNotasBlocksIdsSet set = new JNotasBlocksIdsSet(request,usuario,"CEF-X");
    set.Open();
	for(int i = 0; i < set.getNumRows(); i++)
	{
		String str = set.getAbsRow(i).getEtiqueta(); 
%>
oCMenu.makeMenu('top<%=i%>','','&nbsp;<%=str%>','/servlet/CEFCRMOportunidadesCtrl?entidad=<%=set.getAbsRow(i).getID_Block()%>','cuerpo')
<%
	} 
%>
oCMenu.construct()		
