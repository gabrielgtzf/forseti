...
<%
 	String sts = JUtil.Msj("CEF", "CRM_CALENDARIO", "VISTA", "STATUS");
%>
...
<script>
oCMenu.makeMenu('top0','','&nbsp;<%= JUtil.Elm(sts,1) %>','/servlet/CEFCRMCalendarioCtrl?tiempo=TODO','cuerpo')
oCMenu.makeMenu('top1','','&nbsp;<%= JUtil.Elm(sts,2) %>','/servlet/CEFCRMCalendarioCtrl?tiempo=MIAS','cuerpo')
oCMenu.construct()		
</script>
