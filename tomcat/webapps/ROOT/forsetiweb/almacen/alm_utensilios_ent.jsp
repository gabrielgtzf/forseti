...
<%
    ...
    JAlmacenesMovimSetIdsV2 set = new JAlmacenesMovimSetIdsV2(request,usuario,"CEF-X","G");
    set.Open();
	for(int i = 0; i < set.getNumRows(); i++)
	{
		String str = set.getAbsRow(i).getNombre(); 
%>
oCMenu.makeMenu('top<%=i%>','','&nbsp;<%=str%>','/servlet/CEFAlmUtensiliosCtrl?entidad=<%=set.getAbsRow(i).getID_Bodega()%>','cuerpo')
<%
	} 
%>
oCMenu.construct()		
