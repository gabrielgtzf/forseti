...
*************************************/
oCMenu.makeMenu('top0','','&nbsp;<%= JUtil.Elm(sts,1) %>','/servlet/CEFAlmChFisCtrl?status=TODOS','cuerpo')
oCMenu.makeMenu('top1','','&nbsp;<%= JUtil.Elm(sts,2) %>','/servlet/CEFAlmChFisCtrl?status=GUARDADOS','cuerpo')
oCMenu.makeMenu('top2','','&nbsp;<%= JUtil.Elm(sts,3) %>','/servlet/CEFAlmChFisCtrl?status=EMITIDOS','cuerpo')
oCMenu.makeMenu('top3','','&nbsp;<%= JUtil.Elm(sts,4) %>','/servlet/CEFAlmChFisCtrl?status=CANCELADOS','cuerpo')
