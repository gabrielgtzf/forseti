...
<%
 	String sts = JUtil.Msj("CEF", "ALM_UTENSILIOS", "VISTA", "TIPOS");
%>
...
<script>
oCMenu.makeMenu('top0','','&nbsp;<%= JUtil.Elm(sts,1) %>','/servlet/CEFAlmUtensiliosCtrl?status=MOVIMIENTOS','cuerpo')
oCMenu.makeMenu('top1','','&nbsp;<%= JUtil.Elm(sts,2) %>','/servlet/CEFAlmUtensiliosCtrl?status=EXISTENCIAS','cuerpo')
oCMenu.construct()		
</script>
