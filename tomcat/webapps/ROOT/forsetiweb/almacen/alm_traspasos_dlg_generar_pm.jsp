			...
			<td width="50%" align="left" valign="middle">
              <%  if(JUtil.getSesion(request).getID_Mensaje() == 0 || request.getParameter("proceso").equals("CONSULTAR_MOVIMIENTO")) { %>
        			...
        			<input type="submit" name="aceptar" value="<%= JUtil.Msj("GLB","GLB","GLB","ACEPTAR") %>"/>
       				<%  } %>
        			<input type="button" name="cancelar" onClick="javascript:document.location.href='/servlet/CEFAlmRequerimientosCtrl'" value="<%= JUtil.Msj("GLB","GLB","GLB","CANCELAR") %>"/></td>
  ...
  <tr> 
    <td  bgcolor="#FFFFFF"> 
	  <table width="100%" border="0" cellspacing="2" cellpadding="0">
		  ...
		  <tr>
		    <td><table width="100%"><tr><td align="right"><input name="fecha" type="text" id="fecha" style="width:80%" maxlength="15" readonly="true" value="<%=   ( (request.getParameter("fecha") == null) ? JUtil.obtFechaTxt(rec.getFecha(),"dd/MMM/yyyy")  :  request.getParameter("fecha") )  %>"/></td><td width="24"> 
              <a href="javascript:NewCal('fecha','ddmmmyyyy',false)"><img src="../../imgfsi/calendario.gif" title="<%= JUtil.Msj("GLB","GLB","DLG","CALENDARIO") %>" border="0" align="absmiddle"></a></td></tr></table></td>
          </tr>
        </table>
	</td>
  </tr>
