...
*************************************/
oCMenu.makeMenu('top0','','&nbsp;<%= JUtil.Elm(sts,1) %>','/servlet/CEFContaPolizasCtrl?status=TODAS','cuerpo')
oCMenu.makeMenu('top1','','&nbsp;<%= JUtil.Elm(sts,2) %>','/servlet/CEFContaPolizasCtrl?status=GUARDADAS','cuerpo')
oCMenu.makeMenu('top2','','&nbsp;<%= JUtil.Elm(sts,3) %>','/servlet/CEFContaPolizasCtrl?status=CANCELADAS','cuerpo')
