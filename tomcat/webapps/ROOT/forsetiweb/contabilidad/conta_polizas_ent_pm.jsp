  ...
  <tr> 
    <td>
	  <table width="100%" border="1" bordercolor="#333333" align="center" cellpadding="5" cellspacing="0" bgcolor="#CCCCCC">
	    <tr><td class="titCuerpoBco" align="center" bgcolor="#0099FF"><%= JUtil.getSesion(request).getSesion("CONT_POLIZAS").getPanelEntidad() %></td></tr>
<%
	JContaPolizasClasificacionesSet set = new JContaPolizasClasificacionesSet(request);
	set.m_OrderBy = "ID_Clasificacion ASC";
	set.Open();
	for(int i = 0; i < set.getNumRows(); i++)
	{
		String str = set.getAbsRow(i).getID_Clasificacion();
		String ficha = set.getAbsRow(i).getFicha(); 
%>
		<tr><td align="center"><a href="/servlet/CEFContaPolizasCtrl?entidad=<%=str%>" class="titCuerpoBco" ><%=ficha%></a></td></tr>
<%
	} 
%>
      </table>
