...
<%
	...
	JContPolizasDetalleCETransferenciasSet set = new JContPolizasDetalleCETransferenciasSet(request);
...
<!--ctaori character varying(50) NOT NULL,
  ...
  rfc character varying(13) NOT NULL -->
                ...
                <%= JUtil.Msj("GLB","GLB","GLB","CUENTA",2) %></td>
			<td><input name="ctaori" type="text" id="ctaori" size="80" maxlength="50"<% if(request.getParameter("ctaori") != null) { out.print(" value=\"" + request.getParameter("ctaori") + "\""); }  
					else if(request.getParameter("proceso").equals("CAMBIAR_CE")) { out.print(" value=\"" + set.getAbsRow(0).getCtaOri() + "\""); } else { out.print(""); } %>>
 			</td>
		  </tr>
          <tr>
		    <td align="right"><%= JUtil.Msj("GLB","GLB","GLB","BANCO") %></td>
		  	<td><select name="bancoori" class="cpoBco">
<% 				for(int i = 0; i < setBan.getNumRows(); i++)
				{	%>
					<option value="<%=setBan.getAbsRow(i).getClave()%>"<% 
									if(request.getParameter("bancoori") != null && 
										request.getParameter("bancoori").equals(setBan.getAbsRow(i).getClave()))  {
											out.print(" selected");
									} else if(request.getParameter("proceso").equals("CAMBIAR_CE") && 
										set.getAbsRow(0).getBancoOri().equals(setBan.getAbsRow(i).getClave())) { 
											out.print(" selected");
...
%>				</select></td>
		  ...
		  <tr>
		    <td align="right">Banco Extranjero de Origen</td>
		  	<td><input name="bancooriext" type="text" id="bancooriext" size="80" maxlength="150"<% if(request.getParameter("bancooriext") != null) { out.print(" value=\"" + request.getParameter("bancooriext") + "\""); }  
					else if(request.getParameter("proceso").equals("CAMBIAR_CE")) { out.print(" value=\"" + set.getAbsRow(0).getBancoOriExt() + "\""); } else { out.print(""); } %>>
 			</td>
		  </tr>
		  <tr>
		  	<td align="right"><%= JUtil.Msj("GLB","GLB","GLB","DESTINO") %></td>
			<td><input name="ctadest" type="text" id="ctadest" size="80" maxlength="50"<% if(request.getParameter("ctadest") != null) { out.print(" value=\"" + request.getParameter("ctadest") + "\""); }  
					else if(request.getParameter("proceso").equals("CAMBIAR_CE")) { out.print(" value=\"" + set.getAbsRow(0).getCtaDest() + "\""); } else { out.print(""); } %>>
 			</td>
		  </tr>
          <tr>
		    <td align="right"><%= JUtil.Msj("GLB","GLB","GLB","BANCO") %></td>
		  	<td><select name="bancodest" class="cpoBco">
<% 				for(int i = 0; i < setBan.getNumRows(); i++)
				{	%>
					<option value="<%=setBan.getAbsRow(i).getClave()%>"<% 
									if(request.getParameter("bancodest") != null && 
										request.getParameter("bancodest").equals(setBan.getAbsRow(i).getClave()))  {
											out.print(" selected");
									} else if(request.getParameter("proceso").equals("CAMBIAR_CE") && 
										set.getAbsRow(0).getBancoDest().equals(setBan.getAbsRow(i).getClave())) { 
											out.print(" selected");
									} %>><%= setBan.getAbsRow(i).getNombre() %></option>
			<%	}
%>				</select></td>
		  ...
		  <tr>
		    <td align="right">Banco Extranjero de Destino</td>
		  	<td><input name="bancodestext" type="text" id="bancodestext" size="80" maxlength="150"<% if(request.getParameter("bancodestext") != null) { out.print(" value=\"" + request.getParameter("bancodestext") + "\""); }  
					else if(request.getParameter("proceso").equals("CAMBIAR_CE")) { out.print(" value=\"" + set.getAbsRow(0).getBancoDestExt() + "\""); } else { out.print(""); } %>>
 			</td>
		  </tr>
		  <tr>
