		 ...
		 <tr> 
          <td> 
		    <div align="right">
              ...
              <a href="/servlet/CEFReportesCtrl?tipo=CONT_CATCUENTAS" target="_self"><img src="../imgfsi/rep_contabilidad.png" alt="" title="<%= JUtil.Msj("GLB","GLB","GLB","REPORTES") %>" width="30" height="30" border="0"></a> 
