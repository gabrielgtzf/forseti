...
oCMenu.makeMenu('top0','','&nbsp;<%= JUtil.Elm(ent,1) %>','/servlet/CEFContaEnlacesCtrl?entidad=ALMACEN','cuerpo')
oCMenu.makeMenu('top1','','&nbsp;<%= JUtil.Elm(ent,2) %>','/servlet/CEFContaEnlacesCtrl?entidad=CXP','cuerpo')
oCMenu.makeMenu('top2','','&nbsp;<%= JUtil.Elm(ent,3) %>','/servlet/CEFContaEnlacesCtrl?entidad=CXC','cuerpo')
