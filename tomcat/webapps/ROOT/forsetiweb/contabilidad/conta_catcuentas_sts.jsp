...
<script>
oCMenu.makeMenu('top0','','&nbsp;<%= JUtil.Elm(sts,1) %>','/servlet/CEFContaCatCuentasCtrl?status=TODAS','cuerpo')
oCMenu.makeMenu('top1','','&nbsp;<%= JUtil.Elm(sts,2) %>','/servlet/CEFContaCatCuentasCtrl?status=ACTIVAS','cuerpo')
oCMenu.makeMenu('top2','','&nbsp;<%= JUtil.Elm(sts,3) %>','/servlet/CEFContaCatCuentasCtrl?status=DESCONTINUADAS','cuerpo')
oCMenu.construct()		
</script>
