...
<%
	...
	JContPolizasDetalleCEChequesSet set = new JContPolizasDetalleCEChequesSet(request);
...
{
	if(!esNumeroEntero('<%= JUtil.Msj("GLB","GLB","GLB","CHEQUE") %>:', formAct.num.value, 1, 999999999999)  ||
		!esNumeroDecimal('<%= JUtil.Msj("GLB","GLB","GLB","TOTAL") %>:', formAct.monto.value, 0, 99999999999999.99, 2))
		return false;
	else
	{
...
%> 
        ...
        <table width="100%" border="0" cellspacing="3" cellpadding="0">
          <tr> 
            <td align="right" width="20%">
                ...
                <%= JUtil.Msj("GLB","GLB","GLB","CHEQUE") %></td>
  ...
  rfc character varying(13) NOT NULL,-->
	            <td><input class="cpoColAzc" name="num" type="text" id="num" size="8" maxlength="20"<% if(request.getParameter("num") != null) { out.print(" value=\"" + request.getParameter("num") + "\""); }  
					else if(request.getParameter("proceso").equals("CAMBIAR_CE")) { out.print(" value=\"" + set.getAbsRow(0).getNum() + "\""); } else { out.print(""); } %>></td>
          </tr>
		  <tr>
		  	<td align="right"><%= JUtil.Msj("GLB","GLB","GLB","CUENTA",2) %></td>
...
%>				</select></td>
		  ...
		  <tr> 
            <td align="right">Banco Extranjero Emisor</td>
		  	<td><input name="banemisext" type="text" id="banemisext" size="80" maxlength="150"<% if(request.getParameter("banemisext") != null) { out.print(" value=\"" + request.getParameter("banemisext") + "\""); }  
					else if(request.getParameter("proceso").equals("CAMBIAR_CE")) { out.print(" value=\"" + set.getAbsRow(0).getBanEmisExt() + "\""); } else { out.print(""); } %>>
 			</td>
		  </tr>
		  <tr>
