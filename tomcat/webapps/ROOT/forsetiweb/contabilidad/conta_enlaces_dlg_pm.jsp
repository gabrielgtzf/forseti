...
<form onSubmit="return enviarlo(this)" action="/servlet/CEFContaEnlacesDlg" method="post" enctype="application/x-www-form-urlencoded" name="conta_enlaces_dlg">
<div id="topbar"> 
			...
			<td width="50%" align="left" valign="middle">
			    <%  if(JUtil.getSesion(request).getID_Mensaje() == 0) { %>
        			...
        			<input type="submit" name="aceptar"  value="<%= JUtil.Msj("GLB","GLB","GLB","ACEPTAR") %>"/>
       				<%  } %>
        			<input type="button" name="cancelar" onClick="javascript:document.location.href='/servlet/CEFContaEnlacesCtrl';" value="<%= JUtil.Msj("GLB","GLB","GLB","CANCELAR") %>"/></td>
...
%>
          ...
          <tr> 
            <td><input class="cpoColAzc" name="idconcepto" type="text" style="width:50%" maxlength="10"<% if(request.getParameter("proceso").equals("CAMBIAR_ENLACE")) { out.print(" readonly=\"true\""); } %>/></td>
          </tr>
          <tr> 
            <td><%= JUtil.Msj("GLB","GLB","GLB","DESCRIPCION") %></td>
          </tr>
          <tr> 
            <td><input name="descripcion" type="text" id="nombre" style="width:100%" maxlength="80"/></td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td>
				<select class="cpoColAzc" name="tipo" style="width:90%">
          ...
          <tr> 
            <td><table width="100%"><tr><td width="30%"><input name="cuenta" type="text" id="cuenta" style="width:100%" maxlength="25"/></td> 
              <td width="24"><a href="javascript:abrirCatalogo('../../forsetiweb/listas_dlg_pm.jsp?formul=conta_enlaces_dlg&lista=cuenta&idcatalogo=3&nombre=CUENTAS&destino=cuenta_nombre',250,350)"><img src="../../imgfsi/catalogo.gif" title="<%= JUtil.Msj("GLB","GLB","DLG","CATALOGO") %>" align="absmiddle" width="24" height="24" border="0"/></a></td> 
...
<%
		...
		{
%>
              <select name="tipo" class="cpoColAzc" style="width:90%">
