		  ...
		  <tr>
			<td width="50%" align="left" valign="middle"> 
  			...
  			<td width="50%" align="right" valign="middle">
				<a href="/servlet/CEFAdmMonedasCtrl"><img src="../imgfsi/actualizar24.png" title="<%= JUtil.Msj("GLB","VISTA","GLB","HERRAMIENTAS",1) %>" width="24" height="24" border="0"/></a><img src="../imgfsi/pixel_333333.gif" width="5" height="24"/> 
  ...
  <tr> 
    <td align="right"> 
			  <input name="proceso" type="hidden" value="ACTUALIZAR"/>
				<input name="submit" type="image" onClick="javascript:establecerProcesoSVE(this.form.proceso, 'AGREGAR_MONEDA',<%= JUtil.Msj("CEF","ADM_MONEDAS","VISTA","AGREGAR_MONEDA",4) %>,<%= JUtil.Msj("CEF","ADM_MONEDAS","VISTA","AGREGAR_MONEDA",5) %>)" src="../imgfsi/pm_agregar_bd.png" title="<%= JUtil.Msj("CEF","ADM_MONEDAS","VISTA","AGREGAR_MONEDA",2) %>" width="24" height="24" border="0"/><img src="../imgfsi/pixel_333333.gif" width="5" height="24"/>
              	<input name="submit" type="image" onClick="javascript:establecerProcesoSVE(this.form.proceso, 'CAMBIAR_MONEDA',<%= JUtil.Msj("CEF","ADM_MONEDAS","VISTA","CAMBIAR_MONEDA",4) %>,<%= JUtil.Msj("CEF","ADM_MONEDAS","VISTA","CAMBIAR_MONEDA",5) %>)" src="../imgfsi/pm_cambiar_bd.png" title="<%= JUtil.Msj("CEF","ADM_MONEDAS","VISTA","CAMBIAR_MONEDA",2) %>" width="24" height="24" border="0"/><img src="../imgfsi/pixel_333333.gif" width="5" height="24"/>
	</td>
  </tr> 
</table>
    ...
    <td bgcolor="#0099FF">
	  <table width="100%" border="0" cellpadding="5" cellspacing="0">
          <tr>
			...
			<td width="25%" align="right" class="titChico"><%= JUtil.Elm(coletq,etq++) %></td>
	 	</tr>
	 </table>
	</td>
  </tr>
...
%>
          <tr>
			  ...
			  <td width="20%" align="center"><%= set.getAbsRow(i).getSimbolo() %></td>
			  <td width="25%" align="right"><%= set.getAbsRow(i).getTC()  %></td>
	      </tr>		
<%
	}
%>		
