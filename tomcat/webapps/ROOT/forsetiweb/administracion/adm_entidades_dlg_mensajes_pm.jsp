  ...
  <tr> 
    <td  bgcolor="#FFFFFF"> 
        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="5">
		  ...
		  <tr>
		    <td> <input class="cpoColAzc" name="idblock" type="text" id="idblock" style="width:50%" maxlength="3"<% if(request.getParameter("proceso").equals("CAMBIAR_ENTIDAD")) { out.print(" readonly=\"true\""); } %>/></td>
