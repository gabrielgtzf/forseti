...
<form onSubmit="return enviarlo(this)" action="/servlet/CEFAdmCFDDlg" method="post" enctype="application/x-www-form-urlencoded" name="adm_cfdi_dlg" target="_self">
<div id="topbar"> 
            ...
            <td align="right" class="clockCef"> 
              <%  if(JUtil.getSesion(request).getID_Mensaje() == 0) { %>
        			...
        			<input type="submit" name="aceptar" value="<%= JUtil.Msj("GLB","GLB","GLB","ACEPTAR") %>">
       				<%  } %>
        			<input type="button" name="cancelar" onClick="javascript:document.location.href='/servlet/CEFAdmCFDDlg'" value="<%= JUtil.Msj("GLB","GLB","GLB","CANCELAR") %>">
            </td>
          </tr>
        </table> 
      </td>
  ...
  <tr> 
    <td>
		<table width="100%" border="0" cellspacing="2" cellpadding="0">
          <tr bgcolor="#0099FF"> 
            <td width="3%" class="titChico"> <input name="subproceso" type="hidden" value="ENVIAR"> 
...
%>
 		  <tr> 
            <td>
			 <input name="uuid" type="<%= (request.getParameter("tipomov").equals("GASTOS") ? "checkbox" : "radio") %>" value="<%= set.getAbsRow(i).getUUID() %>">&nbsp;</td>
