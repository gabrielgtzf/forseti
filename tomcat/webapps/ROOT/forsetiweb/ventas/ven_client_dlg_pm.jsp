			...
			<td width="50%" align="left" valign="middle">
			    <%  if(JUtil.getSesion(request).getID_Mensaje() == 0 || request.getParameter("proceso").equals("CONSULTAR_CLIENTE")) { %>
        			...
        			<input type="submit" name="aceptar"  value="<%= JUtil.Msj("GLB","GLB","GLB","ACEPTAR") %>"/>
       				<%  } %>
        			<input type="button" name="cancelar" onClick="javascript:document.location.href='/servlet/CEFVenClientCtrl';" value="<%= JUtil.Msj("GLB","GLB","GLB","CANCELAR") %>"/></td>
	  ...
	  <table width="100%" border="0" cellspacing="5" cellpadding="5">
        <tr>
		  ...
		  <tr> 
			...
			<td width="24"><a href="javascript:abrirCatalogo('../../forsetiweb/listas_dlg_pm.jsp?formul=ven_client_dlg&lista=cuenta&idcatalogo=3&nombre=CUENTAS&destino=cuenta_nombre')"><img src="../../imgfsi/catalogo.gif" title="<%= JUtil.Msj("GLB","GLB","DLG","CATALOGO") %>" align="absmiddle" width="24" height="24" border="0"/></a></td> 
		  ...
		  <tr> 
            <td colspan="2">Envio de CFDI por correo</td>
          </tr>
          <tr> 
            <td colspan="2">
				<select name="smtp" class="cpoBco" style="width:80%">
                	<option value="0"<% 
          ...
          <tr> 
            <td colspan="2"><table width="100%"><tr><td width="30%"><input name="idvendedor" type="text" id="idvendedor" style="width:100%" maxlength="3"/></td> 
              <td width="24"><a href="javascript:abrirCatalogo('../../forsetiweb/listas_dlg_pm.jsp?formul=ven_client_dlg&lista=idvendedor&idcatalogo=23&nombre=VENDEDORES&destino=vendedor_nombre')"><img src="../../imgfsi/catalogo.gif" title="<%= JUtil.Msj("GLB","GLB","DLG","CATALOGO") %>" align="absmiddle" width="24" height="24" border="0"/></a></td> 
              <td><input name="vendedor_nombre" type="text" id="vendedor_nombre" style="width:100%" maxlength="250" readonly="true"/></td></tr></table></td>
          </tr>
          <tr> 
          ...
          <tr> 
          	<td colspan="2">&nbsp;&nbsp;<input name="prespmostr" type="checkbox" id="prespmostr"/><%= JUtil.Elm(etq,4) %></td>
          </tr>
		  <tr> 
...
document.ven_client_dlg.numero.value = '<% if(request.getParameter("numero") != null) { out.print( request.getParameter("numero") ); } else if(!request.getParameter("proceso").equals("AGREGAR_CLIENTE")) { out.print( smod.getAbsRow(0).getNumero() ); } else { out.print(""); } %>'
