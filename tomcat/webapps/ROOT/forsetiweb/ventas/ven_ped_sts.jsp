...
*************************************/
oCMenu.makeMenu('top0','','&nbsp;<%= JUtil.Elm(sts,1) %>','/servlet/CEFVenPedidosCtrl?status=TODOS','cuerpo')
oCMenu.makeMenu('top1','','&nbsp;<%= JUtil.Elm(sts,2) %>','/servlet/CEFVenPedidosCtrl?status=GENERADOS','cuerpo')
oCMenu.makeMenu('top2','','&nbsp;<%= JUtil.Elm(sts,3) %>','/servlet/CEFVenPedidosCtrl?status=CANCELADOS','cuerpo')
oCMenu.makeMenu('top3','','&nbsp;<%= JUtil.Elm(sts,4) %>','/servlet/CEFVenPedidosCtrl?status=FACTURADOS','cuerpo')
