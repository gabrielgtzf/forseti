  ...
  <tr> 
    <td>
	  <table width="100%" border="1" bordercolor="#333333" align="center" cellpadding="5" cellspacing="0" bgcolor="#CCCCCC">
	    <tr><td class="titCuerpoBco" align="center" bgcolor="#0099FF"><%= JUtil.getSesion(request).getSesion("VEN_CLIENT").getPanelTiempo() %></td></tr>
		<tr><td align="center"><a href="/servlet/CEFVenClientCtrl?tiempo=TODO" class="titCuerpoBco" >*</a></td></tr>
<%
	for (char c = 'A'; c <= 'Z'; c++) 
	{
		String str = Character.toString(c);
%>
		<tr><td align="center"><a href="/servlet/CEFVenClientCtrl?tiempo=<%= str %>" class="titCuerpoBco" ><%=str%></a></td></tr>
<%
	}
%>
      </table>
