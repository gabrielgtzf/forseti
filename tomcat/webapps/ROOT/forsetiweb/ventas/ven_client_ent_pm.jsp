  ...
  <tr> 
    <td>
	  <table width="100%" border="1" bordercolor="#333333" align="center" cellpadding="5" cellspacing="0" bgcolor="#CCCCCC">
	    <tr><td class="titCuerpoBco" align="center" bgcolor="#0099FF"><%= JUtil.getSesion(request).getSesion("VEN_CLIENT").getPanelEntidad() %></td></tr>
<%
...
%>
		<tr><td align="center"><a href="/servlet/CEFVenClientCtrl?entidad=<%=set.getAbsRow(i).getID_Entidad()%>" class="titCuerpoBco" ><%=str%></a></td></tr>
<%
	} 
%>
      </table>
