  ...
  <tr> 
    <td>
	  <table width="100%" border="1" bordercolor="#333333" align="center" cellpadding="5" cellspacing="0" bgcolor="#CCCCCC">
	    <tr><td class="titCuerpoBco" align="center" bgcolor="#0099FF"><%= JUtil.getSesion(request).getSesion("BANCAJ_VALES").getPanelStatus() %></td></tr>
		<tr><td align="center"><a href="/servlet/CEFValesCajaCtrl?status=ABIERTOS" class="titCuerpoBco" ><%= JUtil.Elm(sts,1) %></a></td></tr>
		<tr><td align="center"><a href="/servlet/CEFValesCajaCtrl?status=CERRADOS" class="titCuerpoBco" ><%= JUtil.Elm(sts,2) %></a></td></tr>
	  </table>
	</td>
  </tr>
</table>
