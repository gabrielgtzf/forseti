  ...
  <tr> 
    <td>
	  <table width="100%" border="1" bordercolor="#333333" align="center" cellpadding="5" cellspacing="0" bgcolor="#CCCCCC">
	    <tr><td class="titCuerpoBco" align="center" bgcolor="#0099FF"><%= JUtil.getSesion(request).getSesion("INVSERV_GASTOS").getPanelTiempo() %></td></tr>
<%
	int i = 0;
	for (char c = 'A'; c <= 'Z'; c++) 
	{
...
%>
		<tr><td align="center"><a href="/servlet/CEFCatGastosCtrl?tiempo=<%= str %>" class="titCuerpoBco" ><%=str%></a></td></tr>
<%
	}
%>
      </table>
