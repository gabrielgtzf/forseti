...
*************************************/
oCMenu.makeMenu('top0','','&nbsp;<%= JUtil.Elm(ent,1) %>','/servlet/CEFCatLineasCtrl?entidad=LINEAS','cuerpo')
oCMenu.makeMenu('top1','','&nbsp;<%= JUtil.Elm(ent,2) %>','/servlet/CEFCatLineasCtrl?entidad=UNIDADES','cuerpo')
