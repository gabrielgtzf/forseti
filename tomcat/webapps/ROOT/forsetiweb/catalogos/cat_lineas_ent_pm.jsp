...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr> 
    <td align="center" class="titCuerpoAzc"><%= JUtil.Msj("CEF","MENU","INVSERV","LINEAS") %></td>
  </tr>
  <tr> 
    <td>
	  <table width="100%" border="1" bordercolor="#333333" align="center" cellpadding="5" cellspacing="0" bgcolor="#CCCCCC">
	    <tr><td class="titCuerpoBco" align="center" bgcolor="#0099FF"><%= JUtil.getSesion(request).getSesion("INVSERV_LINEAS").getPanelEntidad() %></td></tr>

		<tr><td align="center"><a href="/servlet/CEFCatLineasCtrl?entidad=LINEAS" class="titCuerpoBco" ><%= JUtil.Elm(ent,1) %></a></td></tr>
		<tr><td align="center"><a href="/servlet/CEFCatLineasCtrl?entidad=UNIDADES" class="titCuerpoBco" ><%= JUtil.Elm(ent,2) %></a></td></tr>
