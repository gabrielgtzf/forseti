...
function ventEm()
{
	...
	ventana = window.open('../../forsetiadmin/filtro_esp_por_mes.jsp?fsi_vista=SAFRegistProcCtrl', '', parametrs);
	ventana.focus();
}
</script>
</head>
...
<script>
oCMenu.makeMenu('top1','','&nbsp;Hoy','/servlet/SAFRegistProcCtrl?tiempo=HOY','cuerpo')
oCMenu.makeMenu('top2','','&nbsp;Semana','/servlet/SAFRegistProcCtrl?tiempo=SEM','cuerpo')
oCMenu.makeMenu('top3','','&nbsp;Mes','javascript:ventEm()')
