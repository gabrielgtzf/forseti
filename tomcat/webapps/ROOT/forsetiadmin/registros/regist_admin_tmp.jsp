...
function ventEm()
{
	...
	ventana = window.open('../../forsetiadmin/filtro_esp_por_mes.jsp?fsi_vista=SAFRegistAdminCtrl', '', parametrs);
	ventana.focus();
}
</script>
</head>
...
<script>
oCMenu.makeMenu('top1','','&nbsp;Hoy','/servlet/SAFRegistAdminCtrl?tiempo=HOY','cuerpo')
oCMenu.makeMenu('top2','','&nbsp;Mes','javascript:ventEm()')
