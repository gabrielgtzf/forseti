...
<script>
oCMenu.makeMenu('top0','','&nbsp;SAF','/servlet/SAFRegistIniSesCtrl?entidad=SAF','cuerpo')
oCMenu.makeMenu('top1','','&nbsp;CEF','/servlet/SAFRegistIniSesCtrl?entidad=CEF','cuerpo')
oCMenu.makeMenu('top2','','&nbsp;REF','/servlet/SAFRegistIniSesCtrl?entidad=REF','cuerpo')
