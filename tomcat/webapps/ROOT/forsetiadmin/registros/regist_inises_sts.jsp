...
<script>
oCMenu.makeMenu('top0','','&nbsp;<%= JUtil.Elm(sts,1) %>','/servlet/SAFRegistIniSesCtrl?status=TODAS','cuerpo')
oCMenu.makeMenu('top1','','&nbsp;<%= JUtil.Elm(sts,2) %>','/servlet/SAFRegistIniSesCtrl?status=ACTIVAS','cuerpo')
oCMenu.makeMenu('top2','','&nbsp;<%= JUtil.Elm(sts,3) %>','/servlet/SAFRegistIniSesCtrl?status=BLOQUEADAS','cuerpo')
oCMenu.makeMenu('top3','','&nbsp;<%= JUtil.Elm(sts,4) %>','/servlet/SAFRegistIniSesCtrl?status=CERRADAS','cuerpo')
