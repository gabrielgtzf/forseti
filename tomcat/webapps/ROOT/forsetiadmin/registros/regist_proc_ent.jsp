...
<script>
oCMenu.makeMenu('top0','','&nbsp;SAF','/servlet/SAFRegistProcCtrl?entidad=SAF','cuerpo')
oCMenu.makeMenu('top1','','&nbsp;CEF','/servlet/SAFRegistProcCtrl?entidad=CEF','cuerpo')
oCMenu.makeMenu('top2','','&nbsp;REF','/servlet/SAFRegistProcCtrl?entidad=REF','cuerpo')
