...
<body background="../imgfsi/saf_agua8.gif" leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="titCuerpoBco" align="center" valign="middle" bgcolor="#FF6600"><input name="tiempo" type="hidden" value="MAS"><%= JUtil.Msj("GLB","GLB","GLB","FEM") %></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
