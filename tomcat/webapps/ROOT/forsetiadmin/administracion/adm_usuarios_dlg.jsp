      ...
      <td> 
	     <table width="100%" border="0" cellspacing="3" cellpadding="0">
          <tr> 
            ...
            <td><input class="cpoCol" name="elusuario" type="text" size="12" maxlength="10"<% if(request.getParameter("proceso").equals("CAMBIAR_USUARIO")) { out.print(" readonly=\"true\""); } %>>
			           </td>
          </tr>
          <tr> 
...
document.admin_usuarios_dlg.elusuario.value = '<% if(request.getParameter("elusuario") != null) { out.print( request.getParameter("elusuario") ); } else if(!request.getParameter("proceso").equals("AGREGAR_USUARIO")) { out.print( set.getAbsRow(0).getID_Usuario() ); } else { out.print(""); } %>'
document.admin_usuarios_dlg.nombre.value = '<% if(request.getParameter("nombre") != null) { out.print( request.getParameter("nombre") ); } else if(!request.getParameter("proceso").equals("AGREGAR_USUARIO")) { out.print( set.getAbsRow(0).getNombre() ); } else { out.print(""); } %>' 
</script>
</body>
</html>
