        ...
        <td bgcolor="#333333"> <table width="100%" border="0" cellpadding="0" cellspacing="5">
            <tr> 
              <td> <div align="right"> 
                  ...
                  <input type="image" onClick="javascript: if(confirm('<%= JUtil.Msj("GLB","GLB","GLB","CONFIRMACION",4) %>')) { establecerProcesoSVE(this.form.proceso, 'RESPALDAR_SERVIDOR',<%= JUtil.Msj("SAF","ADMIN_BD","VISTA","RESPALDAR_SERVIDOR",4) %>,<%= JUtil.Msj("SAF","ADMIN_BD","VISTA","RESPALDAR_SERVIDOR",5) %>); } else { return false; } " src="../imgfsi/<%= JUtil.Msj("SAF","ADMIN_BD","VISTA","RESPALDAR_SERVIDOR") %>" alt="" title="<%= JUtil.Msj("SAF","ADMIN_BD","VISTA","RESPALDAR_SERVIDOR",2) %>" border="0">
