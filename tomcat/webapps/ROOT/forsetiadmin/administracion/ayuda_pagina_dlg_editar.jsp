...
<%
	...
	JAyudaPaginaSet set = new JAyudaPaginaSet(null);
	set.ConCat(true);
	    ...
	    <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr> 
            <td>
              ...
              <textarea  name="cuerpo" id="cuerpo" style="width:100%; height:400px"> 
				<% if(request.getParameter("cuerpo") != null) { out.print(request.getParameter("cuerpo")); } else { out.print(set.getAbsRow(0).getCuerpo()); } %>
			  </textarea>
              <script type="text/javascript">
				buttonPath = "textbuttons";
				makeWhizzyWig("cuerpo", "all");
			</script>
           </td>
          </tr>
        </table>
