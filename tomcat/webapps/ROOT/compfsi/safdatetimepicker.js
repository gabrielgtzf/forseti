...
function RenderCal()
{
	...
	//Month Selector
	vCalHeader+="<tr>\n<td bgcolor='#FF6600' colspan='7'><table border=0 width='100%' cellpadding=0 cellspacing=0><tr><td align='left'>\n";
	...
	if (ShowMonthYear)
		vCalHeader+="<tr><td bgcolor='#FF6600' colspan='7'><font face='Verdana' size='2' align='center' color='"+MonthYearColor+"'><b>"+Cal.GetMonthName(ShowLongMonth)+" "+Cal.Year+"</b></font></td></tr>\n";
	//Week day header
