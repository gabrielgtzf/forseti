...
var SelDateColor="#000099";//Backgrond color of selected date in textbox.
...
function RenderCal()
{
	...
	docCal.writeln("</head><body bgcolor='#000099' background='"+ThemeBg+"' link="+FontColor+" vlink="+FontColor+"><form name='Calendar'>");
