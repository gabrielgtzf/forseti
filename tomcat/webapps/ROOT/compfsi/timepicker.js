...
function GenCell()//Generate table cell with value
{
	...
	if (Cal.ShowTime)
	{
		...
		vTimeStr="";		
	PCellStr="<td  align='center'><font face='verdana' size='2'><a href=\"javascript:"+vTimeStr+";window.close();\"><img border=\"0\" src=\"../../forsetiweb/verdadero.gif\" width=\"10\" height=\"10\"></a></font></td>";
	return PCellStr;
}
